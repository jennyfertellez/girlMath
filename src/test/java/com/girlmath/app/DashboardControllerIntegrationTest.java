...
class DashboardControllerIntegrationTest {
    ...
    void shouldReturnCorrectTotalDebt_whenDebtsExist() throws Exception {
        Debt debt1 = new Debt(null, "Chase Credit Card", 2500.0, 24.99, 65.0, 200.0, "CREDIT_CARD", 120000.0, null, false);
    ...
    void shouldReturnMonthsToDebtFree_whenDebtsExist() throws Exception {
        Debt debt = new Debt(null, "Medical Bill", 500.0, 0.0, 100.0, 100.0, "MEDICAL", 500.0, null, false);
