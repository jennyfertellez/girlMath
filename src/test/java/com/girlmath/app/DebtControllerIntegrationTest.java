...
class DebtControllerIntegrationTest {
    ...
    void shouldCreateDebt_andReturnIt() throws Exception {
        Debt debt = new Debt(null, "Chase Credit Card", 2500.0, 24.99, 65.0, 200.0, "CREDIT_CARD");
    ...
    void shouldReturnAllDebts_afterMultipleCreated() throws Exception {
        Debt debt1 = new Debt(null, "Chase Credit Card", 2500.0, 24.99, 65.0, 200.0, "CREDIT_CARD");
        Debt debt2 = new Debt(null, "Student Loan", 18500.0, 5.05, 190.0, 250.0, "STUDENT_LOAN");
    ...
    void shouldDeleteDebt_andReturnNoContent() throws Exception {
        Debt debt = new Debt(null, "Medical Bill", 1200.0, 0.0, 50.0, 100.0, "MEDICAL");
