...
class SnowballControllerIntegrationTest {
    ...
    void shouldReturnPayoffTimeline_whenDebtsExist() throws Exception {
        Debt debt = new Debt(null, "Chase Credit Card", 1000.0, 0.0, 100.0, 100.0, "CREDIT_CARD", 1500.0, null, false);
    ...
    void shouldPayOffFaster_withExtraPayment() throws Exception {
        Debt debt = new Debt(null, "Chase Credit Card", 1000.0, 0.0, 100.0, 100.0, "CREDIT_CARD", 3000.0, null, false);
