...
class GirlMathApplicationTests {
    ...
    void snowball_shouldPayOffDebt_inExpectedMonths() {
        Debt debt = new Debt(null, "Test Card", 1000.0, 0.0, 100.0, 100.0, "CREDIT_CARD", 25000.0);
    ...
    void snowball_shouldPayoffFaster_withExtraPayment() {
        Debt debt = new Debt(null, "Test Card", 1000.0, 0.0, 100.0, 100.0, "CREDIT_CARD", 2500.0);
    ...
    void snowball_shouldSortByBalance_smallestFirst() {
        Debt big = new Debt(null, "Big Debt", 5000.0, 10.0, 100.0, 100.0, "CREDIT_CARD", 10000.0);
        Debt small = new Debt(null, "Small Debt", 500.0, 10.0, 50.0, 50.0, "CREDIT_CARD", 1500.0);
